...
export default function SignInPage() {
  ...
  const { signIn, resetPassword, loading: authLoading, initializing, supabaseError } = useAuth()
          ...
          <div className="mt-6 space-y-4">
            <div className="text-center">
              <Button
                ...
                className="text-sm p-0 h-auto font-normal text-[var(--primary)] hover:text-[var(--primary)]/80 hover:bg-transparent"
              >
